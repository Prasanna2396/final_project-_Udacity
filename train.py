...
def validation(args):  # Added args as a parameter
...
def get_data(args):  # Added args as a parameter
...
def build_model(args, data):  # Added args as a parameter
...
def train(args, model, data):  # Added args as a parameter
...
def save_model(args, model):  # Added args as a parameter
    print("saving model")
...
def create_model(args):  # Added args as a parameter
    validation(args)
    data = get_data(args)
